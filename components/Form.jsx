  ...
  return (
    ...
    ">
      ...
      <p className="desc text-left max-w-md">
        {type} and share amazing prompts with world!
      </p>
      <form onSubmit={handleSubmit}
      className="mt-10 w-full max-w-2xl flex flex-col gap-7 glassmorphism">
      <label >
        <span className="font-santoshi font-semibold text-gray-700">Your AI prompt</span>
      ...
      <label >
        <span className="font-santoshi font-semibold text-gray-700">Tags {` `}
        <span className="font-normal">(#product,#webdevelopment)</span></span>
